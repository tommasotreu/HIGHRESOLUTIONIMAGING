...
profile for the main deflector can be measured \textbf{we find that...}
}
...
\textbf{Question}: What are the point-source magnitudes, even if they're not specifically modelled? How were they assigned?
 Based on the recipe that Kai and I assembled? Also, magnitudes in the tables are not necessarily the instrument ones, how are they converted? With the XLM's template-based table from AA?
...
Here we introduce the telescopes and instruments with their bands... D some of them need special remarks?
