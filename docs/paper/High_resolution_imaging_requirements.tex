...
significantly by this model assumption.
...
ratio of light, position angle, and S$\acute{e}$rsic index for the
...
lenses. This prior helps to converge quickly to to correct
...
components.  As usual the likelihood is assessed through the standard
...
Note that the point-like images of the quasar are time variable and
