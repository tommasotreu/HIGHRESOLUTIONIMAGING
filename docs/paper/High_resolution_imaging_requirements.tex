...
ground based low resolution imaging surveys, we study the requirements
for high resolution imaging follow-up. We consider a range of
...
\item Keck/LGSAO can provide sufficient information for only the brighter systems to be discovered. The critical issue will be the PSF.. Reconstruction tool.
\item The planned Keck/NGAO system will improve the performance of Keck to make it comparable to that of HST, provided that 
\end{itemize}
