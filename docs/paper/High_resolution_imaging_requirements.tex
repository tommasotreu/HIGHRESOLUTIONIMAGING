...
have chosen to make the source galaxies artificially fainter ($K$=26.0)
...
target exposure time. This is meant to provide useful guidance for designing
...
brighter} lenses are too bright to be observed with TMT. 
Likewise the brighter systems are
