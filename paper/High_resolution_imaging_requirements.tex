...
{\bf Actually, in addition to strongly lensed galaxies, strongly
lensed quasars are also searched for.  Many of the additional
systems were discovered with the outside magnitude, redshift, and
image separation selection algorithms to quasars compare with the
statistical lens sample.  Due to the lacking of some crucial parameter
values of host and lens galaxies, we do not use SQLS to perform our
mock simulations.}
...
\cite{2015arXiv150605147R}), in general the AGNs are found to be  0 to 3 magnitudes
