...
We conclude by emphasizing that our estimated uncertainties are only
the random component of the uncertainty, and thus provide a lower
limit to the contribution to the total uncertainty in the time delay
distance from the lens modeling itself. In practice
