...
-- or residual uncertainties from incomplete breaking of the
mass-sheeet degeneracy -- will only increase the error budget (e.g.,
Agnello et al. 2015
\citep{2015arXiv150602720A}) although perhaps not critically in good
conditions (e.g., Marshall et al. 2007 \citep{2007ApJ...671.1196M},
Lagattuta et al. 2012 \citep{2012MNRAS.424.2800L}). Thus, in order to
leave room for additional sources of uncertainty in the error budget,
we set a rather stringent requirement of 0.02 uncertainty of $\gamma'$
(corresponding approximately to 2\% per system on time delay
