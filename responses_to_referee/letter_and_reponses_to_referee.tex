...
7-10. We have corrected the lablels, and switched to absolute errors
on $\gamma'$ throughout in order to avoid any confusion. Indeed, our
target uncertainty is 0.02 on $\gamma'$ (i.e. 2\% on time-delay
distance).
